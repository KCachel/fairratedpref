...
csv_name = 'results/modcloth/results_modcloth.csv'
epira_bnd = .9 #highest observed exposure according to method
epsilon = 0.6
rand_seed = 1
num_rating = 4
#since the dataset is imbalanced (some items have 1000s of rating and others have a handful) take 4 reviews per item
drop_s = rating_df[item_col].value_counts() < num_rating #items with less than 4 reviews
